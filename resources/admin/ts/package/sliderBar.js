...
const sidebarLinks = document.querySelectorAll("#sidebar .side-menu a[data-url]");
...
const allSidebarInteractive = document.querySelectorAll("#sidebar .side-menu a, #sidebar .brand");
allSidebarInteractive.forEach((el) => {
