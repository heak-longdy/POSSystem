...
@section('layout')
    <div class="content-wrapper" x-data="xStockOut">
        <div class="header">
            @include('admin::shared.header', ['header_name' => __('Stock Transfer Management')])
            <div class="header-tab">
                <div class="header-tab-wrapper">
                    <div class="menu-row">
                        <div class="menu-item {!! Request::is('admin/stock-transfer/list') ? 'active' : '' !!}" s-click-link="{!! route('admin-stock-transfer-list') !!}">Data</div>
                    </div>
                </div>
                <div class="header-action-button">
                    ...
                    @can('stock-transfer-create')
                        <button class="btn-create" s-click-link="{!! route('admin-stock-transfer-create') !!}">
        ...
        <div class="content-body">
            @include('admin::pages.inventoryManagement.stockTransfer.table')
        </div>
    </div>
@stop
@section('script')
