                                            ...
                                            <div class="discountGp" x-show="item?.itemData?.discount">
                                                ...
                                                <p>
                                                    <template x-if="item?.itemData?.discountType=='percent'">
                                                        <span x-text="(item?.itemData?.discount ? item?.itemData?.discount : 0) + '%'"></span>
                                                    </template>
                                                    <template x-if="item?.itemData?.discountType=='khr'">
                                                        <span
                                                            x-text="(item?.itemData?.discount ? item?.itemData?.discount.toFixed(2) : 0) + '៛'"></span>
                                                    </template>
                                                </p>
                                            </div>
                ...
                <div class="div paymentListTotalGp">
                    <div class="bookingShopInfoII">
                        ...
                        <div class="shopInfoHeader">
                            <img :src="shopData?.image_url" onerror="(this).src='{{ asset('images/logo/shopLogo.png') }}'">
                            <div class="infoText">
                    ...
                    <div class="paymentGp">
                        ...
                        <div class="orderBtnActionGp">
                            <button type="button" :disabled="submitLoading" class="paymentSub" @click="submitBooking()">
                    ...
                    this.$store.confirmDialog.open({
                        ...
                        afterClosed: (result) => {
                            if (result) {
                                ...
                                data.dataCarts = this.dataCart.length ? JSON.stringify(this
                                    .dataCart) : [];
                                data.shop = this.member ? JSON.stringify(this.shopData) :
                                    null;
                ...
                addToCart(item) {
                    ...
                    let itemData = {
                        price: item?.price ? item?.price : (this.selectType == "product" ? item
                            ?.product?.price : item?.service?.price),
