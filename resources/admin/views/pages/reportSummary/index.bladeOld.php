                    ...
                    @if ($status == 'shop')
                        <div class="table-wrapper">
                            ...
                            <div class="table-body" style="max-height: calc(100% - 120px);height:auto;">
                                @foreach ($data->listing as $index => $item)
                                    <div class="column" style="height: auto;">
                                        ...
                                        <div class="row table-row-10">
                                            <span class="wordBreak">{!! number_format(isset($item->totalPrice) ? $item->totalPrice : 0, 2) !!}KHR</span>
                                        </div>
                                        <div class="row table-row-14">
                                            <span class="wordBreak">{!! number_format(isset($item->totalDiscount) ? $item->totalDiscount : 0, 2) !!}KHR</span>
                                        </div>
                                        <div class="row table-row-15">
                                            <span class="wordBreak">{!! number_format(isset($item->totalAfterDiscount) ? $item->totalAfterDiscount : 0, 2) !!}KHR</span>
                                        </div>
                                        <div class="row table-row-15">
                                            <span class="wordBreak">{!! number_format(isset($item->totalCommission) ? $item->totalCommission : 0, 2) !!}KHR</span>
                                        </div>
                                        <div class="row table-row-13">
                                            <span class="wordBreak">{!! number_format(isset($item->totalInCome) ? $item->totalInCome : 0, 2) !!}KHR</span>
                                        </div>
                                        <div class="row table-row-13">
                            ...
                            <div class="table-footer table-header">
                                ...
                                <div class="row table-row-10">
                                    <span>{!! number_format(isset($data?->total->totalPrice) ? $data?->total->totalPrice : 0, 2) !!}KHR</span>
                                </div>
                                <div class="row table-row-14">
                                    <span>{!! number_format(isset($data?->total->totalDiscount) ? $data?->total->totalDiscount : 0, 2) !!}KHR</span>
                                </div>
                                <div class="row table-row-15">
                                    <span>{!! number_format(isset($data?->total->totalAfterDiscount) ? $data?->total->totalAfterDiscount : 0, 2) !!}KHR</span>
                                </div>
                                <div class="row table-row-15">
                                    <span>{!! number_format(isset($data?->total->totalCommission) ? $data?->total->totalCommission : 0, 2) !!}KHR</span>
                                </div>
                                <div class="row table-row-13">
                                    <span>{!! number_format(isset($data?->total->totalInCome) ? $data?->total->totalInCome : 0, 2) !!}KHR</span>
                                </div>
                                <div class="row table-row-13">
                                    <span>{!! number_format(
