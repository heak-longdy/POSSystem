...
@section('layout')
    @include('admin::shared.header', ['header_name' => 'Supplier Management'])
    <div class="content-wrapper" id="app" x-data="xIndex">
        @component('admin::components.listingData', [
            'routeName' => $routeName,
            'createName' => 'Create Supplier',
            'filterStatus' => true,
            'exportUrl' => $exportUrl ?? '',
            'data' => $data,
            'status' => $status,
            'tbHeader' => [
                ...
                ['field' => 'name', 'title' => 'Name', 'class' => 'text left', 'colVal' => 50],
                ['field' => 'ordering', 'title' => 'Ordering', 'class' => 'text', 'colVal' => 40],
                [
                    'field' => 'action',
                    'title' => "",
                    'class' => '',
