...
@section('layout')
    @include('admin::shared.header', ['header_name' => __('supplier.title')])
    <div class="content-wrapper" id="app" x-data="xIndex">
        @component('admin::components.listingData', [
            'routeName' => $routeName,
            'createName' => __('supplier.button.create'),
            'filterStatus' => true,
            'exportUrl' => $exportUrl ?? '',
            'data' => $data,
            'status' => $status,
            'tbHeader' => [
                ...
                ['field' => 'name', 'title' => __('global.table.name'), 'class' => 'text left', 'colVal' => 50],
                ['field' => 'ordering', 'title' => __('supplier.table.ordering'), 'class' => 'text', 'colVal' => 40],
                [
                    'field' => 'action',
                    'title' => "",
                    'class' => '',
