...
@section('layout')
    @include('admin::shared.header', ['header_name' => 'Pay Note Management'])
    <div class="content-wrapper" id="app" x-data="xIndex">
        @component('admin::components.listingData', [
            'routeName' => $routeName,
            'createName' => 'Create Pay Note',
            'filterStatus' => true,
            'exportUrl' => $exportUrl ?? '',
            'data' => $data,
            'status' => $status,
            'tbHeader' => [
                ...
                ['field' => 'des', 'title' => 'Name (Optional)', 'class' => 'text left', 'colVal' => 30],
                ['field' => 'AmountKhFor', 'title' => 'Amount (KHR)', 'class' => 'text left', 'colVal' => 20],
                ['field' => 'AmountUsdFor', 'title' => 'Amount (USD)', 'class' => 'text left', 'colVal' => 50],
                [
                    'field' => 'action',
                    'title' => "",
                    'class' => '',
