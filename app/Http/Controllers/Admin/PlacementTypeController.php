...
use App\Http\Requests\Admin\PlacementTypeRequest;
...
{
    protected $layout = 'admin::pages.placement_type.';
    private $tools;
    private $table = PlacementType::class;
    private $routeName = "placement-type";
    ...
    public function Save(PlacementTypeRequest $req, $id = "")
    {
