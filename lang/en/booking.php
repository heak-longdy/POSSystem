...
return [
    ...
    'detail' => [
        ...
        'remarks' => 'Booking Remarks & Notes',
        'total_bill' => 'Total Bill',
        'paid_amount' => 'Paid Amount',
        'balance_due' => 'Balance Due',
        'customer_points' => 'Customer Points',
        'stylist_barber' => 'Stylist / Barber',
        'no_payments' => 'No payment transactions recorded yet.',
        'no_remarks' => 'No special notes recorded.',
        'print_invoice' => 'Print Invoice',
        'print_slip' => 'Print Delivery Slip',
        'slip_title' => 'Delivery Slip',
        'slip_preview' => 'Delivery Slip Preview',
    ...
    'invoice' => [
        ...
        'paid' => 'Paid',
        'balance_due' => 'Balance Due',
        'sample_coca' => 'Coca-Cola Bottle 380ml',

        'slip_title' => 'DELIVERY SLIP',
        'slip_draft' => '(DRAFT) OEB',
        'slip_inv_no' => 'Inv. No.',
        'slip_issue_date' => 'Issue Date',
        'slip_delivery_date' => 'Delivery Date',
        'slip_cust_name' => 'Name:',
        'slip_cust_address' => 'Address:',
        'slip_depot_name' => 'Depot Name:',
        'slip_depot_address' => 'Address:',
        'slip_district' => 'District / City:',
        'slip_delivery_branch' => 'Delivery Branch:',
        'slip_col_no' => 'No',
        'slip_col_code' => 'Code',
        'slip_col_desc' => 'Product Name',
        'slip_col_uom' => 'UOM',
        'slip_col_qty' => 'Quantity',
        'slip_col_deliv_qty' => 'Delivery Qty',
        'slip_col_case' => 'Case',
        'slip_col_can' => 'Can',
        'slip_col_cost' => 'Cost Price ($)',
        'slip_col_discount' => 'Discount ($)',
        'slip_col_promo' => 'Promotion ($)',
        'slip_col_net_price' => 'Net Price',
        'slip_col_net_sub' => 'Case Can',
        'slip_col_total' => 'Total ($)',
        'sample_coca_12' => 'Coca-Cola Bottle 12x250ml',
        'slip_free_goods' => '(*) : Free of charge items',
        'slip_total_pay' => 'Total Amount Payable ($)',
        'slip_driver_signature' => 'Driver Signature',
        'slip_customer_signature' => 'Customer Signature',
        'slip_disclaimer' => 'Note: In case of damaged goods or any service issues, personnel must immediately report to the company via the contact numbers above.',
    ],
